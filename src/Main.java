...
public class Main {
    ...
    private static void exercise1() {
        System.out.println("\nExercise 1:");
        String testo1 = "prova di testo";

        System.out.println(testo1.toUpperCase());
        System.out.println(testo1.toLowerCase());
    }
    ...
    private static void exercise2() {
        ...
        String middleName = "Vittorio";
        String lastName = "Carta";

        System.out.print(firstName.toUpperCase() + " " + middleName.toLowerCase() + " " + lastName.toUpperCase());
    }
    ...
    private static void exercise3() {
        ...
        String textFrom2Primitives = "Ciao" + 1.5 + 67; // <--- Edit this line
        System.out.println(textFrom2Primitives);

        textFrom2Primitives += "testo aggiunto ";
        System.out.println(textFrom2Primitives);

        textFrom2Primitives += 'b';
        System.out.println(textFrom2Primitives);

        textFrom2Primitives += false;
        System.out.println(textFrom2Primitives);
    }
